...
import GymTrackerImage from "../../data/img/GymTracker.png";
import GameImg from "../../data/img/GamePic.png";
import Portfolio from "../../data/img/Portfolio_pic.png";
        ...
        {data?.Projects?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            <div className="portfolio--section--img">
              {item.id === "1" && (
                <img src={GymTrackerImage} alt="Gym Tracker App Screenshot" />
              )}
              {item.id === "2" && (
                <img src={GameImg} alt="DuoMatch Card Game Screenshot" />
              )}
              {item.id === "3" && (
                <img src={Portfolio} alt="Portfolio Website Screenshot" />
              )}
            </div>
